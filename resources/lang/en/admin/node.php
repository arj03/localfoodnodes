...
return [
    ...
    'change_weekday_warning' => 'If you change weekday, interval or start date all products on the node will disappear since their selected delivery date doesn\'t match any longer.',
