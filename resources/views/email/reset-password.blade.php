                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td colspan="2" style="padding: 20px;">
                            ...
                            <a style="border: 1px solid #8fb773; background-color: #8fb773; border-radius: 4px; padding: 10px; display: block; margin: 40px auto 20px; width: 160px; text-align: center; text-decoration: none; color: #fff;"  href="{{ app('url')->to('/password/reset/' . $token) }}">{{ trans('public/email.reset_your_password') }}</a>
